    ...
    const cheat = (async () => {
        ...
        const Cheats = {
            global: [
                {
                    name: "Auto Answer",
                    description: "Dont use this if you think that you’re not a lazy hacker!",
                    type: "toggle",
                    enabled: false,
                    data: null,
                    run: function () {
                ...
                },
                {
                    ...
                    description: "This Is My Personal Favourite",
                    type: "toggle",
                    enabled: false,
                    data: null,
                    run: function () {
                ...
                },
                {
                    ...
                    description: "This is for you to figure out (:",
                    type: "toggle",
                    enabled: false,
                    data: null,
                    run: function () {
                ...
                {
                    name: "Auto Answer",
                    description: "I think it is pretty obvious…",
                    run: function () {
                        const { stateNode: { state: { question, stage, feedback }, props: { client: { question: pquestion } } } } = Object.values((function react(r = document.querySelector("body>div")) { return Object.values(r)[1]?.children?.[0]?._owner.stateNode ? r : react(r.querySelector(":scope>div")) })())[1].children[0]._owner;
                        try {
